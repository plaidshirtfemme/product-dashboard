...
import reflex as rx
from ..components import section_header, real_page_header, real_page_wrapper, vault_coverage_chart
...
def real_research_tab() -> rx.Component:
    return real_page_wrapper(
        ...
        section_header("Research Journal"),
        empty_state(
            "Research Journal",
        ...
        section_header("Usability Testing"),
        empty_state(
            "Usability Testing",
