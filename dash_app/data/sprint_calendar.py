...
SPRINT_ROWS: list[dict] = [
    ...
    {"name": "2. Живая команда", "epic": "DASH-EPIC-10", "cells": [
        # Вс 12 — все задачи истории команды собраны на сегодня (по просьбе Guzel):
        # сначала пишем (64 сценарий, 96 история+кризисы+Goals, 65 дневники,
        # 98 персоны, 99 карта обмена), затем вшиваем в данные (97, 69).
        ["DASH-95", "DASH-116"],
        ["DASH-64", "DASH-65", "DASH-98", "DASH-99", "DASH-97"],
        [], [], [], [], [],
    ]},
    {"name": "3. Зритель понимает", "epic": "DASH-EPIC-11", "cells": [
        # Блоки 3-5 комикса: сценарий (100), отрисовка (101), встройка (102), музыка (122)
        [], ["DASH-100"], [], [], ["DASH-101", "DASH-122"], ["DASH-102"], [],
    ]},
