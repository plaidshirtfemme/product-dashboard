...
DASH_OKR_OBJECTIVES: list[Objective] = [
    ...
    # North Star одна — «Кейс → оффер Company 1». Прежние O1-O3 остаются как
    # операционные цели, инструментальные по отношению к O0.
    Objective(
        tag="O0 · North Star",
        title="Оффер продуктового дизайнера от Company 1",
        description="Кейс — главная цель; удобство дашборда для выдуманной команды — инструментальная. "
                    "При конфликте приоритетов побеждает зритель кейса. Запасная цель — Company 3 (тёплый контакт).",
        ...
        key_results=[
            ...
            KeyResult("KR-0.2", "Отклики отправлены (Company 1 + Company 3) ≤ 22.07",
